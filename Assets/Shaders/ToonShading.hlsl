void ToonShading_float(in float3 Normal, in float3 ToonRampSmootheness, in float3 ClipSpacePos, in float3 WorldPos, in float4 ToonRampTinting,
in float ToonRampOffset, out float3 ToonRampOutput, out float3 Direction)
{
    ...
    half toonRamp = smoothstep(ToonRampOffset, ToonRampOffset+ ToonRampSmootheness, d);
